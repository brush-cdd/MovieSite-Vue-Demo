<template>
  ...
  <nav class="menu">
    <div class="container">
      <div class="brand">
        <a href="#">
          <img src="../style/images/logo.png" alt="Magz Logo">
        </a>
      </div>
        ...
        <ul class="nav-list">
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <ul class="vertical-menu">
                      <li>
                        <a href="#">
                          <i class="ion-ios-circle-outline"></i> Mega menu is a new feature
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="ion-ios-circle-outline"></i> This is an example
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="ion-ios-circle-outline"></i> For a submenu item
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="ion-ios-circle-outline"></i> You can add
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="ion-ios-circle-outline"></i> Your own items
                        </a>
                      </li>
                    </ul>
                  </div>
                        ...
                        <div class="inner">
                          ...
                          <div class="padding">
                            ...
                            <h2>
                              <a
                                href="single.html"
                              >Duis aute irure dolor in reprehenderit in voluptate</a>
                            </h2>
                          </div>
                        </div>
                      </article>
          ...
          <li class="dropdown magz-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a href="#">
                  <i class="icon ion-heart"></i> Favorite
                </a>
              </li>
              <li>
                <a href="#">
                  <i class="icon ion-chatbox"></i> Comments
                </a>
              </li>
              <li>
                <a href="#">
              ...
              <li>
                <a href="#">
                  <i class="icon ion-settings"></i> Settings
                </a>
              </li>
              <li class="divider"></li>
              <li>
